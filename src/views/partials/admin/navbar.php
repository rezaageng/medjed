  ...
  <div class="max-w-7xl m-auto sm:flex items-center">
    ...
    <div class="fixed bg-gray-900 sm:bg-transparent z-50 w-full bottom-0 left-0 border-t-[0.1px] border-t-white/50 sm:static sm:border-none">
      <ul class="flex justify-around p-4 sm:justify-end gap-8">
        ...
        <li>
          <a href="./log.php" class="flex gap-2 group">
            <svg class="group-hover:stroke-teal-600" xmlns=" http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-clock">
              <path d="M16 22h2a2 2 0 0 0 2-2V7l-5-5H6a2 2 0 0 0-2 2v3" />
              <path d="M14 2v4a2 2 0 0 0 2 2h4" />
              <circle cx="8" cy="16" r="6" />
              <path d="M9.5 17.5 8 16.25V14" />
            </svg>
            <span class="hidden sm:inline group-hover:text-teal-600">Log</span>
          </a>
        </li>
        <li>
